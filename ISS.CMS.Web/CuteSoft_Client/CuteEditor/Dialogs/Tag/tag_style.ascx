...
var OxO8650=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO8650[1],true)[OxO8650[0]]=function (){if(event[OxO8650[2]]){alert(element[OxO8650[3]].cssText);} ;} ;
</script>
