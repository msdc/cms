<%@ Page Language="C#" AutoEventWireup="true" CodeFile="role_list.aspx.cs" Inherits="Manage_role_list" %>
    ...
    <form id="form1" runat="server">
        <div style="margin: 10px">
            <table style="background-color: #cccccc" border="0" cellpadding="2" cellspacing="1"
                ...
                <tr>
                    <td class="EditInput">
                        <a href="role_mdy.aspx?page=<%=Request["page"] %>">添加角色</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <asp:Repeater ID="rptData" runat="server">
                    <ItemTemplate>
                        <tr align="center">
                            ...
                            <td class="EditInput">
                                <a href="role_mdy.aspx?id=<%# Eval("id") %>&page=<%# Request["page"] %>">编 辑</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
