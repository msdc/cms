<%@ Page Language="C#" AutoEventWireup="true" CodeFile="from_list.aspx.cs" Inherits="Manage_from_list" %>
    ...
    <form id="form1" runat="server">
        <div style="padding: 10px">
            <table style="background-color: #cccccc" border="0" cellpadding="2" cellspacing="1"
                ...
                <tr>
                    <td class="EditInput">
                        <a href="from_mdy.aspx?page=<%=Request["page"] %>">添加来源</a>
                    </td>
                </tr>
            </table>
        </div>
        <div style="padding: 10px">
            <table style="background-color: #cccccc" border="0" cellpadding="2" cellspacing="1"
                ...
                <asp:Repeater ID="RptFrom" runat="server">
                    <ItemTemplate>
                        <tr align="center">
                            <td>
                                <%# Eval("id") %>
                            ...
                            <td class="EditInput">
                                <a href="From_mdy.aspx?id=<%# Eval("id") %>&page=<%# Request["page"] %>">编 辑</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
